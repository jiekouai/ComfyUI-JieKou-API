...
1. Start ComfyUI
2. If you haven't configured the API Key, click the **"⚙️ JieKou AI Settings"** button in the top-right corner
...
To change the saved API Key, edit the `config.ini` file:
